  ...
  return (
    <>
      <div className="bg-white text-black p-6 rounded-lg shadow-sm min-h-screen">
        <h1 className="w-full text-3xl md:text-4xl font-bold mb-4 text-center">
          Welcome to Our <span className="text-pink-500">Learning Space</span>
        </h1>

        <p className="w-full text-base md:text-lg text-gray-700 mb-6 px-4 sm:px-8 md:px-20 lg:px-40 text-center">
