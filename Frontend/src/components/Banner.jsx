  ...
  return (
    ...
    <div className="w-full flex flex-col-reverse md:flex-row items-center">
      ...
      <div className="w-full md:w-1/2 p-8 text-center md:text-left">
        ...
        {/* Input Email area */}
        <div className="flex items-center gap-2 w-full max-w-md md:max-w-lg">
          <label className="flex items-center gap-2 bg-white text-black rounded-lg px-3 py-2 w-full shadow-sm md:w-[400px]">
            <svg
